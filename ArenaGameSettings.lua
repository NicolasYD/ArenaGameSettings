...
local cvarTable = {
    ...
    graphics = {
        ...
        graphicsSSAO = {
            name = "SSAO",
            -- rec = string.format("Recommended: |cFF00FF00%s|r", "Disabled"),
            desc = "Controls the rendering quality of the advanced lighting effects.",
            type = "select",
            values = {
                ["0"] = "Disabled",
                ["1"] = "Low",
        ...
        graphicsGroundClutter = {
            name = "Ground Clutter",
            -- rec = string.format("Recommended: |cFF00FF00%s|r", "1"),
            desc = "Controls the density and the distance at which ground clutter items, like grass and foliage, are placed.",
            type = "range",
            min = 1,
            max = 10,
            step = 1,
